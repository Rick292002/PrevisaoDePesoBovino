...
RESULTS_FILE = "B2 - Cinza - Side.xlsx"
BATCH_SIZE = 16
EPOCHS = 10
K_FOLDS = 10
LEARNING_RATE = 0.001
...
class CattleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = image.repeat(3, 1, 1)  # 🚀 Converte [1, 224, 224] para [3, 224, 224]
    
        metadata = parse_filename(img_name)
...
MODEL_PATH = "B2 - Side - Cinza.pth"
OPTIMIZER_PATH = "optimizer-b2-cinza-side.pth"
...
def predict_new_image(image_path, model):
    ...
    image = image.repeat(1, 3, 1, 1)  # 🚀 Converte [1, 1, 224, 224] para [1, 3, 224, 224]
...
dot.render("Topologia B2 Cinza Side", format="png", cleanup=True)  # Salva como PNG
