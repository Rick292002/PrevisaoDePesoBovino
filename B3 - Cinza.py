...
# Configurações
DATASET_PATH = "dataset/gado/Vector/B3/Side/data/images"
NEW_IMAGE_PATH = "Foto nova/imagens/side.jpg"
RESULTS_FILE = "B3 - Cinza - Side.xlsx"
...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.5], std=[0.5]) #padrão de treino em cinza
])
...
MODEL_PATH = "B3 - Side - Cinza.pth"
OPTIMIZER_PATH = "optimizer-b3-cinza-side.pth"
