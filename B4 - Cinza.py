...
RESULTS_FILE = "B4 - Cinza - Side.xlsx"
BATCH_SIZE = 16
EPOCHS = 10
K_FOLDS = 10
...
MODEL_PATH = "B4 - Side - Cinza.pth"
OPTIMIZER_PATH = "optimizer-b4-cinza-side.pth"
...
def predict_new_image(image_path, model):
    ...
    image = image.repeat(1, 3, 1, 1)  # (batch_size, channels, height, width)
    with torch.no_grad():
...
dot.render("Topologia B4 Cinza Side", format="png", cleanup=True)  # Salva como PNG
